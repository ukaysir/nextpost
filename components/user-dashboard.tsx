  ...
  return (
    <main className="min-h-screen bg-[var(--background)]">
      <header className="np-image-nav text-white">
        <div className="page-shell flex items-center py-7">
        ...
        <section className="page-shell pb-14 pt-8">
          <p className="text-sm font-black tracking-[1px] text-white/80">MY NEXTPOST</p>
          <h1 className="mt-3 max-w-3xl text-4xl font-black leading-tight tracking-normal md:text-6xl">
        ...
        <div className="mt-5 grid gap-5 lg:grid-cols-[0.65fr_0.35fr]">
          <section className="np-card p-6">
            <div className="flex items-center justify-between gap-3">
              <h2 className="text-2xl font-black tracking-normal">내 리포트</h2>
              <Link
                className="focus-ring inline-flex h-10 items-center rounded-[9px] bg-[var(--accent)] px-4 text-sm font-black text-white"
                href="/analyze"
              >
                새 분석
              </Link>
            ...
            <div className="mt-5 grid gap-3">
              {isLoading ? (
                  ...
                  >
                    <div className="flex flex-wrap items-start justify-between gap-3">
                      <div className="min-w-0">
                        <p className="truncate text-lg font-black">{report.title}</p>
                        <p className="mt-1 text-sm font-bold text-[var(--caption)]">
                    ...
                    <div className="mt-4 flex flex-wrap gap-2">
                      {report.local_only ? (
                        <button
                          className="focus-ring inline-flex h-10 items-center gap-2 rounded-[9px] border border-[var(--border)] px-4 text-sm font-black"
                          type="button"
                ...
                <div className="rounded-[14px] border border-dashed border-[var(--border)] bg-white p-8 text-center">
          ...
          <aside className="np-card p-6">
            <h2 className="text-2xl font-black tracking-normal">관심 기업</h2>
            <div className="mt-5 grid gap-3">
