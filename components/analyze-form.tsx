  ...
  async function submit() {
    ...
    try {
      const response = await fetch("/api/analyze", {
        ...
        body: JSON.stringify({ ...form, certifications }),
      });
    ...
    <div className="page-shell py-8">
      ...
      <div className="grid gap-8 lg:grid-cols-[0.76fr_0.24fr]">
          ...
          <div className="grid gap-5 md:grid-cols-2">
            ...
            <Field label="복무년수">
              <input
                ...
                onChange={(event) => updateField("years_served", Number(event.target.value))}
              />
            </Field>
        ...
        <aside className="rounded-lg border border-[var(--border)] bg-white p-6 shadow-sm">
          ...
          {isLoading ? (
            <div className="mt-6 rounded-md bg-[#eef5f2] p-4 text-sm font-semibold text-[var(--primary)]">
